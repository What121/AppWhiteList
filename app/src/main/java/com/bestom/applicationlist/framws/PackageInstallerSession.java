...
//
//
//       if (! TextUtils.equals(SystemProperties.get("ro.target.twoos"),"a")) {
//		   Slog.d(TAG, "twoos's value != a");
//          //add by cs 2019.07.01 11:40
//             if (isBlackList(mPackageName)){
//                 throw new PackageManagerException(INSTALL_FAILED_INTERNAL_ERROR, "on the black list");
//             }
//
//             if (!isWhiteList(mPackageName)){
//                 throw new PackageManagerException(INSTALL_FAILED_INTERNAL_ERROR, "Not on the white list");
//             }
//
//       }
//
...
//        boolean bool = false;
//        List<String> packages = AppListUtil.queryPackage(AppListUtil.whitepath);
//        for (String str : packages){
//            if (str.equals(pkgName)){
//                bool = true;
//            }
//        }
//		Slog.d(TAG, "return judge Whitelist result"+bool);
//        return bool;
//    }
//
//	/**
...
//     * @return
//     */
//    private boolean isBlackList(String pkgName){
//		Slog.d(TAG, "pkgname:"+pkgName);
//        boolean bool = false;
//        List<String> packages = AppListUtil.queryPackage(AppListUtil.blackpath);
//        for (String str : packages){
//            if (str.equals(pkgName)){
//                bool = true;
//            }
//        }
//		Slog.d(TAG, "return judge Blacklist result"+bool);
//        return bool;
//    }
//}
